...
object Constants {
    ...
    const val ERROR_NICKNAME = "Tolong masukan nama panggilan"
    const val ERROR_EMAIL = "Tolong masukan email"
    const val ERROR_VALIDATE_EMAIL = "Email tidak valid"
    const val ERROR_PASSWORD = "Tolong masukan kata sandi"
    const val ERROR_RE_PASSWORD = "Kata sandi tidak cocok"
}